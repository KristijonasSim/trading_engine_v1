...
class AiHypothesisabbec17e2f(IStrategy):
    timeframe = "1h"
    can_short = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe["ema_fast"] > dataframe["ema_slow"]) & (dataframe["atr_pct"] > 0.002) & (dataframe["rsi"] > 53) & (dataframe["volume"] > 0), "enter_long"] = 1
        return dataframe
